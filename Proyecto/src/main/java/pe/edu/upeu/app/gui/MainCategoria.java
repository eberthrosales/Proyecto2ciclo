...
public class MainCategoria extends javax.swing.JFrame {
    ...
    public void ListarCategoria() {
        ...
        List<CategoriaTO> listarCategoria = cDao.listarCategoria();
        ...
        for (int i = 0; i < listarCategoria.size(); i++) {
            ob[0] = i+1;
            ob[1] = listarCategoria.get(i).getIdCategoria();
    ...
    private void paintForm() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            cDao = new CategoriaDAO();
            CategoriaTO d = cDao.buscarCategoria(Integer.parseInt(valor.toString()));
            txtIdCategoria.setText(String.valueOf(d.getIdCategoria()));
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(25, 25, 25)
                                .addComponent(txtIdCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(txtIdCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (jTable1.getSelectedRowCount() > 0) {
            try {
                ...
                msg = new MsgBox();
                if (msg.showConfirmCustom("Esta seguro de eliminar esta categoria: " + valor + "?", "Mensaje de Confirmación", "") == 0) {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (fila != -1) {
            to.setIdCategoria(Integer.parseInt(txtIdCategoria.getText()));
            try {
